...
if __name__ == '__main__':
    try:
        print("SiSideBar startup script has begun")
        __register_sisidebar_startup()
        print("SiSideBar startup script has finished")

    except Exception as e:
        print("SiSideBar startup script has ended with error")
